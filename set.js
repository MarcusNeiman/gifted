...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~myhwVRgb#0bQJIV6Qjdv0xn1fZCjmfLU4yrD1W2Fp5eLTZ68HDMk", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254725693306", // Only 1 owner Number Here, others Add to sudo numbers...
...
BAD_WORDS: process.env.BAD_WORDS || "fuck, pussy, anus, idiot, mjinga, umbwa", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
